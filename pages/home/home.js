...
Page({
  ...
  data: {
    ...
    taglist1: {
      title: '小六说事',
      items: [{
          src: '/static/images/home/icon1.png',
          text: '思政建设',
          tag: '/pages/xxsaid/thoughtPolitical/thoughtPolitical'
        },
        {
          src: '/static/images/home/icon2.png',
          text: '活动动态',
          tag: '/pages/xxsaid/activity/activity'
        },
        {
          src: '/static/images/home/icon5.png',
          text: '政策法规',
          tag: '/pages/xxsaid/policy/policy'
        },
        {
          src: '/static/images/home/icon6.png',
          text: '校园公告',
          tag: '/pages/xxsaid/rules/rules'
        },
      ]
    },
    taglist2: {
      title: '学生服务',
      items: [{
          src: '/static/images/home/icon3.png',
          text: '校园黄页',
          tag: '/pages/studentService/contactIndex/contactIndex'
        },
        {
          src: '/static/images/home/icon4.png',
          text: '认识自我',
          tag: '/pages/studentService/whoamI/whoamI'
        },
        ...
        {
          src: '/static/images/home/icon7.png',
          text: '签到领积分',
          tag: 'modalqd'
        },
        {
          src: '/static/images/home/icon8.png',
          text: '积分排行榜',
          tag: '/pages/studentService/ranking/ranking'
        },
      ]
    },
