...
Page({
  ...
  getdata() {
    ...
    var params = {}
    wx.request({
      url: app.globalData.apiRoot + app.globalData.api.rules, 
      method: 'POST',
      data: {
  ...
  tapview(event) {
    ...
    wx.navigateTo({
      url: '/pages/newsDetails/newsDetails?api=' + app.globalData.api.rulesDetails + '&id=' + event.currentTarget.dataset.id
    })
  },
  /**
   * 页面的初始数据
